...
public class BillingInformationService {
    ...
    public BillingInformationService(
    ...
    public BillingInformation getBillingInformation(UUID id) {
        return this.billingInformationRepository.findById(id).orElseThrow(() ->
                new RuntimeException(
                    "Billing information not found with ID: " + id
                )
            );
    }
    ...
    public BillingInformationDTO getBillingInformationDTO(
        ...
        return this.billingInformationRepository.findDTOByIdAndUserId(
                id,
                userId
            ).orElseThrow(() ->
                new RuntimeException(
                    "Billing information not found with ID: " +
                    id +
                    " for user " +
                    userId
                )
    ...
    public List<BillingInformationDTO> getAllBillingInformation(UUID userId) {
        return this.billingInformationRepository.findAllDTOsByUserId(userId);
    }
    ...
    public BillingInformationDTO updateBillingInformation(
        ...
        BillingInformation entity = billingInformationRepository
        ...
        BillingInformation updatedEntity =
            this.billingInformationRepository.save(entity);
